  ...
  companion object {
    ...
    private val MIGRATION_1_2: Migration = object : Migration(1, 2) {
      override fun migrate(db: SupportSQLiteDatabase) {
        ...
        db.execSQL("DROP TABLE anywhere_table")
        // Change the table name to the correct one
        db.execSQL("ALTER TABLE anywhere_new RENAME TO anywhere_table")
      }
    }
    private val MIGRATION_2_3: Migration = object : Migration(2, 3) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("UPDATE anywhere_table SET param_3=null")
      }
    }
    private val MIGRATION_3_4: Migration = object : Migration(3, 4) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE anywhere_table ADD COLUMN category TEXT")
    ...
    private val MIGRATION_4_5: Migration = object : Migration(4, 5) {
      override fun migrate(db: SupportSQLiteDatabase) {
        ...
        // Remove the old table
        db.execSQL("DROP TABLE page_table")
        // Change the table name to the correct one
        db.execSQL("ALTER TABLE page_new RENAME TO page_table")
      }
    }
    private val MIGRATION_5_6: Migration = object : Migration(5, 6) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE anywhere_table ADD COLUMN color INTEGER NOT NULL DEFAULT 0")
      }
    }
    ...
    private val MIGRATION_7_8: Migration = object : Migration(7, 8) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE page_table ADD COLUMN backgroundUri TEXT")
      }
    }
    private val MIGRATION_8_9: Migration = object : Migration(8, 9) {
      override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE anywhere_table ADD COLUMN iconUri TEXT")
      }
    }
